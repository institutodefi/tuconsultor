...
const datos = {
  ...
  proyectos: [
    { id:'P1', cliente_id:'CL1', estado:'activo', modelo:'Compromiso', normas:['9001'], precio_mes:800, fecha_inicio:'2026-01-20', fecha_fin:en(20) },
    { id:'P2', cliente_id:'CL1', estado:'cerrado', modelo:'Implantación', normas:['14001'], precio_total:6000, fecha_fin:'2025-06-01' },
