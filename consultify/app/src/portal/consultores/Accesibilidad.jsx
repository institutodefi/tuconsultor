...
export default function Accesibilidad() {
  ...
  function declarar() {
    const texto = generarDeclaracion(filas, conf, {
      ...
      alcance: 'Todas las páginas bajo el dominio, en sus cinco versiones idiomáticas (es, en, fr, de, ar), y la aplicación Orbita.PMTools en consultify.tuconsultor.com/app.',
