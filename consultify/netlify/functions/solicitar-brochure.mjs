...
const EMAIL_I18N = {
  es: {
    ...
    ps: 'Si tienes cualquier duda, respóndenos a este correo o escríbenos por WhatsApp al +34 672 462 321.',
  ...
  en: {
    ...
    ps: 'Any questions? Just reply to this email or message us on WhatsApp at +34 672 462 321.',
  ...
  ar: {
    ...
    ps: 'لأي استفسار، يمكنك الرد على هذا البريد أو مراسلتنا عبر واتساب على 34672462321+.',
