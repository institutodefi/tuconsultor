...
|---|---|---|
| `1-confirmacion.html` | Confirm sign up | Confirma tu correo · Orbita 360 |
| `2-invitacion.html` | Invite user | Te damos acceso a Orbita 360 |
| `3-enlace-magico.html` | Magic link or OTP | Tu enlace de acceso · Orbita 360 |
| `4-cambio-de-correo.html` | Change email address | Confirma tu correo nuevo · Orbita 360 |
| `5-recuperar-password.html` | Reset password | Cambia tu contraseña · Orbita 360 |
| `6-reautenticacion.html` | Reauthentication | Tu código de verificación · Orbita 360 |
...
logotipo de **Orbita 360**, rasterizado a JPEG desde el SVG animado: los correos
